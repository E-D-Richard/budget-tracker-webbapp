...
- figure out how to unite all transaction text-data into a single transaction-record element without removing from or breaking grid. This should then allow to highlight whole row on hover
